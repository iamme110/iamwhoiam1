...
class FrameRestorer:
    def __init__(self, device: torch.device, video_file: str, max_clip_length: int, mosaic_restoration_model_name: str,
                 mosaic_detection_model: MosaicDetectionModel, mosaic_restoration_model: torch.nn.Module, preferred_pad_mode: str, video_reader_writer_factory: video_utils.VideoReaderWriterFactory,
        ...
        self.mosaic_detector = MosaicDetector(self.mosaic_detection_model, self.video_meta_data.video_file,
                                              ...
                                              video_reader_writer_factory=self.video_reader_writer_factory)
