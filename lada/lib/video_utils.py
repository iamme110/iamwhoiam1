...
class VideoWriter:
    ...
    def __init__(
        ...
        self.frame_queue: deque[av.VideoFrame] = deque()
    ...
    def write(self, frame: np.ndarray|torch.Tensor, frame_pts: int|None = None, bgr2rgb=False, apply_colorspace=False):
        ...
        if frame_pts not in self.pts_set:
            ...
            self.frame_queue.append(out_frame)
