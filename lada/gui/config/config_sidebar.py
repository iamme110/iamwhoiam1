...
class ConfigSidebar(Gtk.Box):
    ...
    switch_row_moov_front = Gtk.Template.Child()
    ...
    def init_sidebar_from_config(self, config: Config):
        ...
        self.switch_row_moov_front.set_active(config.moov_front)
    ...
    @Gtk.Template.Callback()
    @skip_if_uninitialized
    def switch_row_moov_front_active_callback(self, switch_row, active):
        self._config.moov_front = switch_row.get_property("active")
