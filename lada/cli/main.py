...
def setup_argparser() -> argparse.ArgumentParser:
    ...
    group_general.add_argument('--decoding-device', type=str, default=None, help=_('Specify the hardware device to use for video decoding. '
                                                      'If set, the video will be decoded using the specified hardware; '
                                                      'otherwise, CPU decoding is used. Use "--list-decode-devices" to see what\'s available. '
                                                      '(default: %(default)s)'))
