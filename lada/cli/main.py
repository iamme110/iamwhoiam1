...
def setup_argparser() -> argparse.ArgumentParser:
    ...
    group_general.add_argument('--fp16', action=argparse.BooleanOptionalAction, default=gpu_has_tensor_cores(), help=_("Use FP16 precision for restoration and detection models. Reduces memory usage. (default: True if GPU has tensor cores)"))
